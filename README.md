...
The simulation strategy is explained in detail in the following reference:
	...
	[paper](https://iopscience.iop.org/article/10.1088/1748-0221/14/10/P10020) 
...
*noutascii_biosample.dat*. the small file should be used whenever visualization is wanted and for 	
debugging purposes, see point 6 below. The large sample file contains ~2*10^8 neutron trajectories generated by Vitess for a biosample. A calculation of the detector response consisting of 30 Mantle modules and a sample file of this size takes around ~16 h on my MacBookPro 8-Core Intel Core i9, 2.4 GHz.   
